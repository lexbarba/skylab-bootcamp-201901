...
describe('user api', () => {
    ...
    describe('register', () => {
        ...
        it('should fail when name is a boolean', () => {
            expect(()=> userApi.register(true, surname, username, password)).to.throw(TypeError, 'true is not a string')
        })

        it('should fail when surname is a number', () => {
            expect(()=> userApi.register(name, 1, username, password)).to.throw(TypeError, `1 is not a string`)
        })
        ...
        it('should fail when username is a boolean', () => {
            expect(()=> userApi.register(name, surname, true, password)).to.throw(TypeError, `true is not a string`)
        })
        ...
        it('should fail when password is an array', () => {
            expect(()=> userApi.register(name, surname, username, [1,2,3])).to.throw(TypeError, `1,2,3 is not a string`)
        })
    ...
    describe('authenticate', () => {
        ...
        it('should fail on wrong username', () =>
            userApi.authenticate(usernameTest, password)
                ...
                .catch(error => {
                    expect(error).to.exist
                    expect(error.message).to.equal(`user with username \"${usernameTest}\" does not exist`)
                })
        ) 
        ...
        it('should fail when username is a boolean', () => {
            expect(()=> userApi.authenticate(true, password)).to.throw(TypeError, `true is not a string`)
        })
        ...
        it('should fail when password is an array', () => {
            expect(()=> userApi.authenticate(username, [1,2,3])).to.throw(TypeError, `1,2,3 is not a string`)
        })   
    ...
    describe('retrieve', () => {
        ...
        it('should fail on wrong id', () =>{
            ...
            .catch(({message}) => expect(message).to.equal(`token id \"${_id}\" does not match user \"wrong id\"`))
        })
        ...
        it('should fail when id is a number', () => {
            expect(()=> userApi.retrieve(1, _token)).to.throw(TypeError, `1 is not a string`)
        })

        it('should fail when token is a boolean', () => {
            expect(()=> userApi.retrieve(_id, true)).to.throw(TypeError, `true is not a string`)
        })
    ...
    describe('update', () => {
        ...
        it('should fail on empty data', () => {
            expect(()=> userApi.update(_id, _token, '')).to.throw(Error, 'data is empty')
        })

        it('should fail when id is a number', () => {
            expect(()=> userApi.update(1, _token, data)).to.throw(TypeError, `1 is not a string`)
        })

        it('should fail when token is a boolean', () => {
            expect(()=> userApi.update(_id, true, data)).to.throw(TypeError, `true is not a string`)
        })

        it('should fail on array as data', () => {
            expect(()=> userApi.update(_id, _token, [1,2,3])).to.throw(TypeError, '1,2,3 is not an object')
        })
    })
  ...
  describe('remove', () => {
        ...
        it('should fail on wrong username', () => {
            return userApi.remove(_id, _token, 'wrong username', password)
                ...
                .catch(({message}) => expect(message).to.equal(`username and/or password wrong`))
        })
        ...
        it('should fail on empty password', () => {
            expect(()=> userApi.remove(_id, _token, username, '')).to.throw(Error, 'password is empty')
        })

        it('should fail when username is a boolean', () => {
            expect(()=> userApi.remove(_id, _token, true, password)).to.throw(TypeError, `true is not a string`)
        })

        it('should fail when password is an array', () => {
            expect(()=> userApi.remove(_id, _token, username, [1,2,3])).to.throw(TypeError, `1,2,3 is not a string`)
        })

        it('should fail when id is a number', () => {
            expect(()=> userApi.remove(1, _token, username, password)).to.throw(TypeError, `1 is not a string`)
        })

        it('should fail when token is a object', () => {
            expect(()=> userApi.remove(_id, {'wrong':'token'}, username, password)).to.throw(TypeError, `[object Object] is not a string`)
        })
